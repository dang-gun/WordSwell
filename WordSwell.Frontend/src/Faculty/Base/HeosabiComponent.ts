...
export default class HeosabiComponent
{
    ...
    {
        this.DomThisComplete(this.DomThis);
        this.RenderingComplete();
    }

    public AsyncRenderingStart()
    {
        this.RenderingStart(this.GetPagePath);
    }
     ...
     * @returns {void}
     */
    public DomThisComplete(domThis?: HTMLElement): void
    { }
    ...
    private InitializeChildComponents(): void
    {
        ...
        {
            const component: HeosabiComponent = child.component;
